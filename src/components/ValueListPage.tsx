  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-16 text-center">
      ...
      <p className="text-gray-400 max-w-2xl mx-auto mb-12">
        Browse all Attack on Titan Revolution trading values.  
        {items.length}+ items updated daily.
      </p>
      ...
      <div className="mb-12">
        ...
        <p className="text-gray-500 text-sm mt-2">
          Sets the default mode for all items (but can still be changed per-card).
        </p>
      </div>
